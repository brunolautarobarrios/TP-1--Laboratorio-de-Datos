...
ruta_csv = Path("C:/Users/2013b/OneDrive/Documentos/data science/segundo año/laboratorio de datos/tp1/bibliotecas-populares.csv")
...
columnas_MR = ["id_biblioteca", "nombre_biblioteca", "id_departamento", "año_fundacion", "dominio_email"]
biblioteca_clean = biblioteca_2[columnas_MR]

# Ruta de salida
ruta_salida = Path("C:/Users/2013b/OneDrive/Documentos/data science/segundo año/laboratorio de datos/tp1/bibliotecas_populares_limpio.csv")
